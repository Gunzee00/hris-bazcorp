                        ...
                        <div class="container-fluid px-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input name="tax_number" type="number" class="form-control"  >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input name="bpjs_ketenagakerjaan" type="number" class="form-control"  >
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="col-form-label form-label">BPJS Kesehatan</label>
                                    <input name="bpjs_kesehatan" type="number" class="form-control" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input name="basic_salary" type="number" class="form-control" required>
                                </div>
                            </div>
