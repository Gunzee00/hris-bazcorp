<div class="row">
    <div class="col-md-6">
        ...
        <img id="newImagePreview" src="#" alt="New Image Preview"
            style="width: 200px; max-height: 200px; margin-top: 10px; display: none;">
    </div>
</div>
<div class="row">
    <div class="col-md-3">
...
<script>
    ...
    $('#image').change(function() {
        ...
        const maxSizeKB = 500; // Set max file size in KB

        if (file) {
            compressImage(file, maxSizeKB).then((compressedFile) => {
                const reader = new FileReader();
                reader.onload = function(e) {
                    $('#newImagePreview').attr('src', e.target.result).show();
                    $('#oldImagePreview').hide(); // Hide old image preview when new image is selected
                };
